...
export default function UserResponseDetailPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      setSections(Array.isArray(sectionsData) ? sectionsData : (sectionsData as any).sections || [])
    } catch (err) {
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Detail Submission Saya</h1>
                <p className="text-gray-600">Lihat jawaban lengkap dari submission Anda</p>
              </div>
            </div>
          </div>
